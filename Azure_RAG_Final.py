...
def azure_payload(user_input, convo_history):
    ...
    "data_sources": [
        ...
        "parameters": {
            ...
            "index_name": "vector-search-index-2",
        ...
        if res["choices"][0]["message"]["context"]["citations"]:
            ...
            payload = {
                ...
                "messages": [{
                    ...
                    NOTE: Do not say anything about their relevence in your response. Make sure not to repeat the {user_input} in the response you give.
